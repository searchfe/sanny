...
glob('syntaxes/**/*.yaml', { nocase: true }, (_, files) => {
  ...
  const generatedGrammar = getGeneratedGrammar('syntaxes/san.tmLanguage.json', defaultCustomBlocks);
  writeFileSync('syntaxes/san-generated.json', generatedGrammar);
  console.log('Generated san-generated.json');
});
